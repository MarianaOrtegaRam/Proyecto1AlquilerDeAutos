...
public class PanelEntregarVehiculo extends JPanel{

	SistemaAlquilerAutos sistema;	

	public PanelEntregarVehiculo(SistemaAlquilerAutos sistema) {
        ...
        aceptarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                boolean entregarVehiculo = sistema.entregaVehiculo(placa);
