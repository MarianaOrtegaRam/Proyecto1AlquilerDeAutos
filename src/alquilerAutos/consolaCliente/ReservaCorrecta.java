...
public class ReservaCorrecta extends JFrame {
    ...
    public ReservaCorrecta(ArrayList<String> datosReserva) {
        ...
        setLayout(layout);
        String sedeRecoger_ = datosReserva.get(1);
        String sedeEntregar_ = datosReserva.get(2);
        String fechaRecoger_ = datosReserva.get(3);
        String rango_ = datosReserva.get(4);
        String fechaEntrega_ = datosReserva.get(5);
        String seguro_ = datosReserva.get(6);
        String idReserva_ = datosReserva.get(0);
